...
class FriendTablesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create friend_table" do
    assert_difference('FriendTable.count') do
      post friend_tables_url, params: { friend_table: { age: @friend_table.age, email: @friend_table.email, first_name: @friend_table.first_name, last_name: @friend_table.last_name } }
    end
  ...
  test "should update friend_table" do
    patch friend_table_url(@friend_table), params: { friend_table: { age: @friend_table.age, email: @friend_table.email, first_name: @friend_table.first_name, last_name: @friend_table.last_name } }
